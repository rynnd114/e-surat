            ...
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form method="POST" class="pt-3">
                <div class="form-group">
                  <input type="number" name="nik" class="form-control form-control-lg" placeholder="NIK Anda.." maxlength="16" min="0" required autofocus>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <input type="password" name="password" class="form-control form-control-lg" placeholder="Password" minlength="8" required>
                </div>
                <div class="mb-4">
