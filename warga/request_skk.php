...
if (isset($_POST['kirim'])) {
	...
	$sql = "INSERT INTO data_request_skk (
        nik,scan_kk_k,nama_almarhum, nik_a, jenis_kelamin, tempat_lahir_a, tanggal_lahir_a, agama_a, anak_ke,
        ...
        '$nik','$file_kk_k','$nama_almarhum', '$nik_a', '$jenis_kelamin', '$tempat_lahir_a', '$tanggal_lahir_a', '$agama_a', '$anak_ke',
        '$nama_ayah', '$nama_ibu', '$pekerjaan_a', '$kewarganegaraan', '$alamat_a', '$tanggal_kematian', '$waktu_kematian',
        '$tempat_kematian', '$penyebab_kematian', '$tempat_pemakaman', '$tanggal_pemakaman', '$waktu_pemakaman'
    )";
